...
<style>
    /* ===== TIJARI THEME - FORMULAIRE PRODUIT ===== */
    ...
    <div class="tijari-card">
        ...
        <div class="tijari-header">
            <div class="d-flex align-items-center justify-content-center gap-3 ps-4 pe-4">
                <i class="fa-solid fa-box-open tijari-icon"></i>
                <div class="text-center">
                    <h3 class="fw-bold mb-1" style="color: var(--tijari-dark); font-size: 24px;">
                        Ajouter un Produit
                    </h3>
                    <p class="text-muted mb-0" style="font-size: 14px;">
                        Enregistrez un nouveau produit avec son fournisseur
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-4">
            ...
            <div class="info-section">
                ...
                <strong>Conseil :</strong> Sélectionnez d'abord un fournisseur existant, puis remplissez les informations du produit.
            ...
            {{-- Formulaire --}}
            <form action="{{ route('produits.store') }}" method="POST" novalidate>
                @csrf
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        @if(old('fournisseur_id'))
                            @php
                                $selectedFournisseur = $fournisseurs->find(old('fournisseur_id'));
                            @endphp
                            @if($selectedFournisseur)
                                <div class="supplier-badge mt-2">
                                    <i class="fa-solid fa-check-circle"></i>
                                    Fournisseur sélectionné: <strong>{{ $selectedFournisseur->nom }}</strong>
                                </div>
                            @endif
                        @endif
                    </div>
